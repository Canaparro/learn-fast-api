...
from services.token_store_v2.src.persistence.database import DatabaseManager
...
if __name__ == "__main__":
    uvicorn.run("services.token_store_v2.src.app:app", host="0.0.0.0", port=8000, reload=True)